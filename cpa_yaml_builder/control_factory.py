...
def auto_import_controls():
    ...
    """
    import cpa_yaml_builder.controls.classic
    import cpa_yaml_builder.controls.modern

    import cpa_yaml_builder.controls as controls_pkg
    for finder, name, ispkg in pkgutil.walk_packages(controls_pkg.__path__, controls_pkg.__name__ + "."):
